...
public class ResourceManager {
    ...
    public Sprite getGrubBullet(){
    	return GrubBulletSprite;
    }
    ...
    */
    ...
    public TileMap inputMap() {
        ...
        while (map == null) {
            try {
            	...
            	System.out.println("Map not found. Find correct filename.");
                map = null;
            }
        }
    ...
    private void loadPowerUpSprites() {
      ...
      //create "GrubBullet"
        anim = new Animation();
        Image image = loadImage("GrubBullet.png");
        anim.addFrame(image, 150);
        Animation anim2 = new Animation();
        anim2.addFrame(getMirrorImage(image), 150);
        GrubBulletSprite = new GrubBullet(anim2, anim, anim2, anim);
        
        // create "Bullet"
        anim = new Animation();
        Image image3 = loadImage("bullet.png");
        anim.addFrame(image3, 150);
        Animation anim4 = new Animation();
        anim4.addFrame(getMirrorImage(image3), 150);
        bulletSprite = new Bullet(anim,anim4,anim,anim4);
